...
const HeroSection = () => {
  return (
    <section className="pt-20 lg:pt-32 pb-12 lg:pb-20 relative overflow-hidden">
      {/* Background effects */}
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="flex justify-center mb-6 lg:mb-12">
          <div className="inline-flex items-center gap-1.5 lg:gap-2 px-4 lg:px-6 py-2 lg:py-2.5 rounded-full bg-gradient-to-r from-secondary/20 to-primary/20 border border-secondary/30 animate-pulse-glow">
